...
estado:{// cuando creamos un user lo ponemos por defecto en activo, y si si lo eliminamos lo que hacemos es que los ponemos en false
    type:Boolean,
    default:true
},
google:{// si es user fue creado por google/ if the user was created by google
    type:Boolean,
    default:false
}
